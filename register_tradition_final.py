...
load_dotenv()
NOTION_TOKEN = os.getenv("NOTION_TOKEN_ORDER")  # ✅ これが正しいトークン
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN')
TRADITION_DB_ID = "2ab00160-1818-81ad-b8f5-fe86d2f2b78c"
TRADITION_CHANNEL_ID = 1438876441226903673

message_id = 1438901794171387995
name = "妊婦の焼香禁忌"
overview = "妊婦は通夜や告別式の際には、参列してもいいが焼香してはいけない"
details = "お腹の子供に障りがあるため、妊婦は焼香を避ける"
tags = ["妊婦", "焼香", "通夜", "告別式", "禁忌"]
taboo = "妊婦が焼香すると、お腹の子供に障りがある"
