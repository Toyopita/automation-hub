...
class Config:
    ...
    NOTION_DATABASE_ID = os.environ.get('AIRCON_CONTROL_NOTION_DB', '2a800160-1818-8138-8a0f-f07369a651e7')
    ...
    # 冬季設定
    WINTER_HEATING_START = 22  # 室温22℃未満で暖房開始
    WINTER_HEATING_TARGET = 27  # 暖房設定温度27℃
