#!/usr/bin/env python3
"""
Discord ⇒ Notion タスクメモ自動登録（本番版 - UI改善）

Discordの「🗒️｜タスクメモ」チャンネルの投稿を監視し、
...
TASK_CHANNEL_ID = 1434168803326951456  # 🗒️｜タスクメモ
...
if __name__ == "__main__":
    run_with_retry(client, DISCORD_TOKEN, 'タスクMonitor')
